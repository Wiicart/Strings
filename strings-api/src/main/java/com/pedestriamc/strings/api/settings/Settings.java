...
public interface Settings {
     ...
     * @return The value
     */
    @NotNull String getString(@NotNull Option.Text option);
     ...
     * @return The value
     */
    @NotNull String getColored(@NotNull Option.Text option);
     ...
     * @return The value
     */
    @NotNull List<String> getStringList(@NotNull Option.StringList option);
