 ...
 */
abstract class AbstractHorizontalProximityChannelTest extends AbstractChannelTest {
    ...
    void getRecipients_userOutOfRange_isExcluded() {
        ...
        when(sender.horizontalDistanceSquared(outOfRange)).thenReturn(400.1);
        when(outOfRange.horizontalDistanceSquared(sender)).thenReturn(400.1);
    ...
    void getRecipients_userInRange_isIncluded() {
        ...
        when(sender.horizontalDistanceSquared(recipient)).thenReturn(100.0);
        when(recipient.horizontalDistanceSquared(sender)).thenReturn(100.0);
    ...
    void getRecipients_userInNumericalRangeButDifferentLocality_isExcluded() {
        ...
        when(sender.horizontalDistanceSquared(otherUser)).thenReturn(100.0);
        when(otherUser.horizontalDistanceSquared(sender)).thenReturn(100.0);
    ...
    void getRecipients_userHasSenderIgnored_isExcluded() {
        ...
        when(sender.horizontalDistanceSquared(ignorer)).thenReturn(100.0);
        when(ignorer.horizontalDistanceSquared(sender)).thenReturn(100.0);
        when(sender.getLocality()).thenAnswer(i -> locality);
    ...
    void getRecipients_userHasChannelMuted_isExcluded() {
        ...
        when(sender.horizontalDistanceSquared(muter)).thenReturn(100.0);
        when(muter.horizontalDistanceSquared(sender)).thenReturn(100.0);
        when(sender.getLocality()).thenAnswer(i -> locality);
