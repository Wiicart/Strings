package com.pedestriamc.strings.common.external;
...
public class ModrinthService {
    ...
    private static final String HEADER_VALUE = "wiicart/strings/" + 1.7 + " (wiicart.net)";
    ...
    public ModrinthService(@NotNull StringsPlatform strings) {
        ...
        textureId = strings.settings().get(Option.Text.TEXTURES_MODRINTH_ID);
        try {
            cache = getLatestPack();
        } catch(Exception e) {
