...
public final class Option {
    ...
    public enum Text implements CoreKey<String> {
        DM_FORMAT_OUTGOING("msg-format-outgoing", "&8(&7me &8» &7{recipient_username}&8) &e{message}"),
        DM_FORMAT_RECEIVING("msg-format-receiving", "&8(&7{sender_username} &8» &7me&8) &e{message}"),
